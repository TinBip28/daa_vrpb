...
def visualize_vrpb_solution(instance_data, all_tours_nodes, total_distance, title="VRPB Solution"):
    # (Giữ nguyên hàm visualize_vrpb_solution từ phiên bản RL)
    # ... (copy code từ phiên bản RL vào đây) ...
    ...
    if all_tours_nodes: # Đảm bảo all_tours_nodes không rỗng
    ...
    full_title = f"{title}\nTổng quãng đường: {total_distance:.2f} | Số tours: {len(all_tours_nodes) if all_tours_nodes else 0}"
